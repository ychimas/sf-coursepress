// EJEMPLO: curso-config.js generado dinámicamente
// Este archivo muestra cómo se vería el resultado cuando un usuario crea un curso
...
const CURSO_CONFIG = {
  ...
  lecciones: {
    leccion1: {
      nombre: "1° Introducción al trabajo seguro en Alturas",
      sliders: [
    ...
    leccion2: {
      nombre: "2° Evaluación de riesgos y planificación del trabajo en alturas",
      sliders: [
...
Cuando un usuario crea un curso con:
- Nombre: "Trabajo Seguro en Alturas"
- Lección 1: "Introducción al trabajo seguro en Alturas" con 4 momentos
- Lección 2: "Evaluación de riesgos y planificación" con 3 momentos

El sistema automáticamente:
1. Genera este archivo curso-config.js con la configuración correcta
2. Crea las carpetas: module/leccion1/ y module/leccion2/
3. Dentro de cada lección crea las carpetas de momentos: momento1_1, momento1_2, etc.
4. Cada momento tiene su index.html, slider.css y slider.js
5. Los nombres de las lecciones se toman directamente de lo que escribió el usuario

Si el usuario pone "Introducción a las alturas" como nombre de lección,
automáticamente aparece como:
nombre: '1° Introducción a las alturas'
*/